export default function FeedCard({ incident }) {
  ...
  return (
    <div className="group bg-bgCard mt-5 w-full ml-3 mr-3 p-5 rounded-2xl border border-[#1f2937] text-white hover:border-cyan-500 hover:bg-[#0f172a] transition cursor-pointer">
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className={`flex items-center gap-2 text-xs px-3 py-1 rounded-full font-semibold ${severityColors[incident.severity]}`}>
      ...
      <div className="flex justify-between items-center text-sm">
        ...
        <span className="text-gray-400">
          {incident.assets} assets affected
        </span>
